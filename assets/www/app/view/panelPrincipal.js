...
Ext.define('MyApp.view.panelPrincipal', {
                                ...
                                items: [
                                    {
                                        ...
                                        id: 'idListaResumen',
                                        itemTpl: [
                                            '<div>Rason: <b>{collection.reason}</b><br> Monto Pagado: <font color="#A60000">${collection.total_paid_amount}</font><br>Fecha de pago: <b>{collection.money_release_date}</b></div>'
                                        ],
                                        store: 'storeResumen'
                                    }
                                ]
    ...
    onMysearchfield2Keyup: function(textfield, e, eOpts) {
        ...
        store.filter( 'title', filtro, true,false);
        store.load();
    },
    ...
    onPanelPrincipalShow: function(component, eOpts) {
        if(usss){
            Ext.getCmp("panelPrincipal").setActiveItem(1);
        }else{
